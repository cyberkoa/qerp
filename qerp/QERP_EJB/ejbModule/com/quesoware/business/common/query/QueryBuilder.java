...
public final class QueryBuilder {
	 ...
	 * 
	 * @param property
	 *            eg. "u.emailAddress". This would be converted to "u.emailAddress like ".
	 * @param value
	 *            eg. "Goo" or "%.net". These would be converted to "'Goo%'" and "'%.net%'".
	 */
	 ...
	 * 
	 * @param property
	 *            eg. "u.emailAddress". This would be converted to "lower(u.emailAddress) like ".
	 * @param value
	 *            eg. "Goo" or "%.net". These would be converted to "lower('goo%')" and "lower('%.net%')".
	 */
	 ...
	 * 
	 * @param property
	 *            eg. "u.expiryDate". This would be converted to "u.expiryDate = ".
	 * @param value
	 *            Any valid object, eg. a Date or a String.
	 */
	 ...
	 * 
	 * @param property
	 *            eg. "u.statusCode". This would be converted to "lower(u.statusCode) = ".
	 * @param value
	 *            A string, eg. "ACTIVE". This would be converted to "lower('ACTIVE')". Can be null.
	 */
	 ...
	 *            eg. "u.expiryDate". This would be converted to "u.expiryDate = ".
	 * @param value
	 *            Any valid object, eg. a Date or a String. If empty (null, empty string, or whitespace string) then
	 ...
	 *            eg. "u.statusCode". This would be converted to "lower(u.statusCode) = ".
	 * @param value
	 *            A string, eg. "ACTIVE". This would be converted to "lower('ACTIVE')". If empty (null, empty string, or
	 *            whitespace string) then this operation will be abandoned and the query will not have changed.
	 */
	 ...
	 * 
	 * @param property
	 *            eg. "u.statusCode". This would be converted to "u.statusCode in ".
	 * @param values
	 *            A list of objects, eg. a list of strings such as {"ACTIVE", "SUSPENDED"}. This would be converted to
	 *            ('ACTIVE', 'SUSPENDED').
	 */
	 ...
	 *            eg. "ComparisonOperator.EQ". Theis would be converted to ">".
	 * @param value
	 *            A single object (eg. a String, a Long, a Date).
	 */
	 ...
	 *            eg. "u.expiryDate".
	 * @param fromValue
	 *            Can be null, in which case it will be left out of the test. If toValue is also null then no test will
	 *            be generated.
	 * @param toValue
	 *            Can be null, in which case it will be left out of the test. If fromValue is also null then no test
	 *            will be generated.
	 * @param includeEquals
	 *            eg. true will result in a test like "fromValue <= property <= toValue". false will result in a test
	 *            like "fromValue < property < toValue".
	 */
	 ...
	 * @param objectPrefix
	 *            This will be prepended to the sorting column names found in the options object.
	 * @return A query object ready to use.
	 */
