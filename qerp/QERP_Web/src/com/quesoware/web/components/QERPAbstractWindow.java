 ...
 */
@IncludeJavaScriptLibrary(value = {"${tapestry.scriptaculous}/effects.js", "${commons.scripts}/window/window.js",
        "${commons.scripts}/window/window_effects.js"})
...
abstract public class QERPAbstractWindow implements ClientElement
{
    /**
    ...
    void beginRender(MarkupWriter writer)
    {
       ...
       // String scriptPathSymbolValue = symbolSource.expandSymbols("${ck.components}") + "/window/themes";
        String scriptPathSymbolValue = symbolSource.expandSymbols("${commons.scripts}") + "/window/themes";
