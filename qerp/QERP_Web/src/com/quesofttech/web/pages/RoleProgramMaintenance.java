    ...
    void _UpdateRecord(){
       ...
       if(roleProgram !=null)
       {
           try {
               ...
               _logger.info("RoleProgram_update_problem");
               e.printStackTrace();
               _form.recordError(getMessages().get("RoleProgram_update_problem"));
           }
       }
    }
    ...
    void _DeleteRecord(Long id) {
       ...
       if(roleProgram!=null)
       {
           try {
               ...
               _logger.info("RoleProgram_Delete_problem");
               e.printStackTrace();
               _form.recordError(getMessages().get("RoleProgram_Delete_problem"));
           }
       }
    }
