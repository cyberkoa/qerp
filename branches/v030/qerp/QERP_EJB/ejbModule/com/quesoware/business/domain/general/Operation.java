package com.quesoware.business.domain.general;
...
@Entity
@Table(name = "Operation", uniqueConstraints = { @UniqueConstraint(columnNames = { "opr_Code" }) })
@SuppressWarnings("serial")
public class Operation extends BaseEntity {
	

	//For Postgresql : @SequenceGenerator(name = "Operation_sequence", sequenceName = "Operation_id_seq")
	//Generic solution : (Use a table named primary_keys, with 2 fields , key &  value)
	@TableGenerator(  name="Operation_id", table="PrimaryKeys", pkColumnName="tableName", pkColumnValue="Operation", valueColumnName="keyField")
	@Id
	//For Postgresql : @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Operation_sequence")
	//For MSSQL      : @GeneratedValue(strategy = GenerationType.IDENTITY)
	//Generic solution :
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "Operation_id")	
	...
	@OneToMany(cascade=CascadeType.ALL, fetch = FetchType.EAGER, mappedBy="operation", targetEntity=<ForeignTable>.class)
	...
	*/
	...
	public boolean equals(Object obj) {
		return (obj == this) || (obj instanceof Operation) && getId() != null && ((Operation) obj).getId().equals(this.getId());
	}
    ...
    */
	...
	public void validate() throws BusinessException {
		...
		if (StringUtil.isEmpty(code)) {
			throw new ValueRequiredException(this, "Operation_Code");
		}
		

		if (StringUtil.isEmpty(type)) {
			throw new ValueRequiredException(this, "Operation_Type");
		}

		if (StringUtil.isEmpty(description)) {
			throw new ValueRequiredException(this, "Operation_Description");
		}
